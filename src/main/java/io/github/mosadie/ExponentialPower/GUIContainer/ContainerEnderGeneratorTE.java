...
public class ContainerEnderGeneratorTE extends Container {
    ...
    public ContainerEnderGeneratorTE(IInventory playerInv, EnderGeneratorTE te) {
        ...
        // Tile Entity, Slot 0, Slot IDs 0 
                this.addSlotToContainer(new CustomStackLimitSlot(ExponentialPower.getConfigProp(ExponentialPower.CONFIG_ENDER_GENERATOR, "MaxStack", "Controls the number of Ender Cells required to reach the maximum power output.", Integer.toString(64)).getInt(), te, 0, 80, 35));
