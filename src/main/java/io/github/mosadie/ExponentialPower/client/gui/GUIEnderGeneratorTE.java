...
public class GUIEnderGeneratorTE extends GuiContainer {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
    	...
    	this.fontRendererObj.drawString("Current Power:", guiLeft+5, guiTop+60, 1, false);
    	this.fontRendererObj.drawString(te.currentOutput + " MF/t", guiLeft+5, guiTop+70, 1, false);
    }
}
